                            ...
                            @forelse($gaushalas as $key => $gaushala)
                                <tr>
                                    ...
                                    <td>
                                        @if ($gaushala->gaushala_photo)
                                            <img src="{{ asset('storage/' . $gaushala->gaushala_photo) }}"
                                                alt="Gaushala Photo" class="gaushala-thumb">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <small
                                            class="text-muted d-block">{{ \Illuminate\Support\Str::limit($gaushala->full_address, 60) }}</small>
                                        <small class="text-muted d-block">{{ $gaushala->district }},
                                            {{ $gaushala->state }}</small>
                                        <small class="text-muted d-block">Hours:
                                            {{ $gaushala->working_hours ?: 'N/A' }}</small>
                                    </td>
                                    ...
                                    <td>
                                        @if ($gaushala->emergency_availability === 'yes')
                                            <span
                                                class="badge bg-success-subtle text-success px-3 py-2 rounded-pill">Yes</span>
                                        @else
                                            <span
                                                class="badge bg-secondary-subtle text-secondary px-3 py-2 rounded-pill">No</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        @if ($gaushala->status == 'active')
                                            <span
                                                class="badge bg-success-subtle text-success px-3 py-2 rounded-pill">Active</span>
                                        @else
                                            <span
                                                class="badge bg-danger-subtle text-danger px-3 py-2 rounded-pill">Inactive</span>
                                        @endif
                                    </td>
